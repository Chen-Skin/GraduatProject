                ...
                <table class="table table-striped list-table">
                    ...
                    <c:forEach items="${list}" var="financing">
                        <tr>
                            ...
                            <shiro:hasAnyRoles name="system,chairman,financing">
                            <td>
                                <button id="${financing.id}" class="btn btn-danger btn-xs btnpay" href="">付款</button>
                            </td>
                            </shiro:hasAnyRoles>
                        </tr>
                    </c:forEach>
    ...
    $(document).ready(function() {
        ...
        $('.btnpay').click(function () {
            ...
            swal({
                ...
                $.post("/financing/approve",{"status":3,"id":id},function (result) {
                    if(result=="true"){
                        swal({title:"付款完成",text:"付款完成,返回待付款批列表",type:"success"},function () {
                            location.href="/financing/list?status=2";
                        });
                    }else{
                        swal("付款失败","请检查数据有效性","error");
                    }
                },"text");
